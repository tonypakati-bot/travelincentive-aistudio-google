                    ...
                    <table className="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            {filteredInvites.map(invite => (
                                <tr key={invite.id} className="bg-white border-b last:border-b-0 hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end space-x-2">
                                            ...
                                            <button onClick={() => handleDeleteAction(invite.id)} className="p-1.5 text-red-500 hover:text-red-700 rounded-md hover:bg-red-100">
