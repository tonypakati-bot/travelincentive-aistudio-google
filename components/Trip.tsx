            ...
            <div className="flex items-center space-x-4">
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="pl-10 pr-4 py-2 w-72 bg-gray-800 border border-gray-600 rounded-lg text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                    />
                </div>
                 <div className="relative">
                    <select
